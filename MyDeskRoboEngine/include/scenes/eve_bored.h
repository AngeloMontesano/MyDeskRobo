...
static const RenderOp kEveBored0ps[] = {
    ...
    {true, "CutTop",    LayerOp::DrawCut,  Primitive::RoundedRect, Side::Both, true, true, {0, -20}, {104, 52}, 3, 0, {ColorMode::SceneBackground, lv_color_hex(0x06080d), false}, LV_OPA_COVER},
