...
typedef enum {
  ...
  DESKROBO_EMOTION_LOCKED,
  DESKROBO_EMOTION_WIFI,
  DESKROBO_EMOTION_ESP_NORMAL,
  DESKROBO_EMOTION_ESP_TIRED,
  DESKROBO_EMOTION_ESP_GLEE,
  DESKROBO_EMOTION_ESP_WORRIED,
  DESKROBO_EMOTION_ESP_FOCUSED,
  DESKROBO_EMOTION_ESP_ANNOYED,
  DESKROBO_EMOTION_ESP_SURPRISED,
  DESKROBO_EMOTION_ESP_SKEPTIC,
  DESKROBO_EMOTION_ESP_FRUSTRATED,
  DESKROBO_EMOTION_ESP_UNIMPRESSED,
  DESKROBO_EMOTION_ESP_SUSPICIOUS,
  DESKROBO_EMOTION_ESP_SQUINT,
  DESKROBO_EMOTION_ESP_FURIOUS,
  DESKROBO_EMOTION_ESP_SCARED,
  DESKROBO_EMOTION_ESP_AWE,
} DeskRoboEmotion;
...
typedef enum {
  ...
  DESKROBO_STYLE_PLAYFUL = 2,
  DESKROBO_STYLE_ROBO = 3,
} DeskRoboFaceStyle;
